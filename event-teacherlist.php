  ...
  <header>
    ...
    <div class="container">
      ...
      <table class="table table-bordered">
        ...
        <?php
        $id=$_GET["id"];
        $sql = "SELECT * FROM eventregistration AS e, users AS u, department AS d WHERE u.department = d.departmentid AND e.userid = u.academicid AND e.eventid = '$id' AND e.category = 'teacher'";
