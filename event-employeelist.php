...
<body>
  <header>
    ...
    <div class="container">
      <h2>Teacher List attending in the Event</h2>         
      <table class="table table-bordered">
        ...
        <?php
        $id=$_GET["id"];
        $sql = "SELECT * FROM eventregistration AS e, users AS u, department AS d WHERE u.department = d.departmentid AND e.userid = u.academicid AND e.eventid = '$id' AND e.category = 'employee'";
